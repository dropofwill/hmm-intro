(function() {
  ...
  HMM = (function() {
    ...
    HMM.prototype.setup_force = function() {
      return this.force.nodes(this.graph.nodes).links(this.graph.links).size([this.width, this.height]).alpha(0.01).friction(0.1).linkDistance(this.link_dist).on("tick", this.tick).start();
    };
