(function() {
  ...
  HMM = (function() {
    ...
    HMM.prototype.draw_state = function() {
      ...
      if (this.transitioning) {
        ...
        if (this.current_link.ctrl != null) {
          ...
          src = this.singlenode_arc_origin(this.current_link.source);
          start_angle = src.sub(this.current_node).theta;
          l(start_angle * 180 / Math.PI);
          tmp_pt = this.circle_xy_at_percent(src, 40, this.transition_percent, start_angle);
        }
    ...
    HMM.prototype.quad_xy_at_percent = function(src, ctrl, trg, percent) {
      ...
      this.ctx.fillRect(src.x, src.y, 10, 10);
      this.ctx.fillRect(ctrl.x, ctrl.y, 10, 10);
      this.ctx.fillRect(trg.x, trg.y, 10, 10);
      this.ctx.restore();
    ...
    HMM.prototype.draw_singlenode_arc = function(src, r) {
      ...
      this.ctx.beginPath();
      vec = this.singlenode_arc_origin(src, r);
